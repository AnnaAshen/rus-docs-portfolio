...
4.	Задайте ширину (**W**) и высоту (**H**) фрэйма вручную или выберите готовый фрэйм из выпадающего списка **Frame** на панели свойств.</br>
...
*(Обратите внимание, что не все шрифты из списка поддерживают кириллицу.)*
